...
\newenvironment{CSLReferences}[2] % #1 is the sectioning level
 {\list{}{\setlength{\leftmargin}{\cslhangindent}\setlength{\parsep}{0pt}\setlength{\topsep}{0pt}%
  \ifnumgreater{#1}{0}{\setlength{\itemsep}{0pt}}{}%
...
\usepackage{pdfpages}
\begin{document}
\includepdf[pages={1}, fitpaper=true]{\detokenize{/var/folders/mr/twkc4jg14f3cl5vr1lh0kgl80000gn/T/tmpqkoz_x8p/intro.pdf}}
\sloppy
\tableofcontents
...
документ и отформатирован как блок кода \citep{ref-ref1}.

\centertitle{Использованные источники}

\phantomsection\label{refs}
\begin{CSLReferences}{0}{0}
\bibitem[\citeproctext]{ref-doe2021}
\CSLLeftMargin{{[}1{]} }%
\CSLRightInline{Doe, {``An example paper,''} \emph{Journal of Example
Studies}, vol. 1, no. 1, pp. 1--10, 2021.}

\bibitem[\citeproctext]{ref-doe2022}
\CSLLeftMargin{{[}2{]} }%
\CSLRightInline{D. Sew, {``An example paper,''} \emph{Journal of Example
Studies}, vol. 1, no. 1, pp. 1--10, 2021.}

\bibitem[\citeproctext]{ref-ref1}
\CSLLeftMargin{{[}3{]} }%
\CSLRightInline{J. Doe, {``An example paper,''} \emph{Journal of Example
Studies}, vol. 1, no. 1, pp. 1--10, 2021.}
