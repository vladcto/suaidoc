...
\usepackage{pdfpages}
\begin{document}
\includepdf[pages={1}, fitpaper=true]{\detokenize{/var/folders/mr/twkc4jg14f3cl5vr1lh0kgl80000gn/T/tmp5ok_uk9u/intro.pdf}}
\sloppy
\tableofcontents
...
документ и отформатирован как блок кода \cite{ref-ref1} \cite{ref-ref2}.
...
2. Doe J. An example paper // Journal of Example Studies. 2021. № 1 (1).
C. 1--10.
