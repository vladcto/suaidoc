...
\usepackage{pdfpages}
\begin{document}
\includepdf[pages={1}, fitpaper=true]{\detokenize{/var/folders/mr/twkc4jg14f3cl5vr1lh0kgl80000gn/T/tmp9xzxzodo/intro.pdf}}
\sloppy
\tableofcontents
...
документ и отформатирован как блок кода (Doe 2021).
...
Doe, John. 2021. {``An Example Paper.''} \emph{Journal of Example
Studies} 1 (1): 1--10.
