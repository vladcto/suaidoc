...
\setlist[itemize,1]{label=\textbullet, topsep=0.25pt, partopsep=0.25pt, parsep=0pt, itemsep=0pt, wide=1.25cm}
\setlist[itemize,2]{label=\textbullet, topsep=0.25pt, partopsep=0.25pt, parsep=0pt, itemsep=0pt, wide=2.5cm}
\setlist[itemize,3]{label=\textbullet, topsep=0.25pt, partopsep=0.25pt, parsep=0pt, itemsep=0pt, wide=3.75cm}
\setlist[itemize,4]{label=\textbullet, topsep=0.25pt, partopsep=0.25pt, parsep=0pt, itemsep=0pt, wide=5.0cm}
% = tightlist fix
\def\tightlist{}
...
\usepackage{pdfpages}
\begin{document}
\includepdf[pages={1}, fitpaper=true]{$mypath$}
\sloppy
\tableofcontents
$body$
\end{document}
