...
UPD: [Недавно появился шаблон ГОСТа для Typst](https://typst.app/universe/package/modern-g7-32/). Лучше использовать его, так как он удобнее и расширяемей, чем Markdown + костыли для конвертации через Pandoc.
